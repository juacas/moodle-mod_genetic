...
*********************************************************************************/
	...
	if ($action == "") {	
		...
		echo "<FORM NAME=\"addbeform\" METHOD=\"post\" ACTION=\"\" ENCTYPE=\"multipart/form-data\">";
		...
		echo "<INPUT TYPE=\"button\" VALUE=\"".$str = get_string("save", "genetic")."\" NAME=\"buttonsave\" onClick=\"this.form.action='editbe.php?id=$id';this.form.submit();\"/>&nbsp;&nbsp;";
