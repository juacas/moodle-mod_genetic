<?php  // $Id: viewty.php,v 1.0 2012/06/26 19:40:00 Ana Mar�a Lozano de  la Fuente Exp $
/*********************************************************************************
...
*********************************************************************************/
	...
	// Log table
    add_to_log($course->id, "genetic", "view images", "viewim.php?id=$cm->id", "$genetic->id");
    ...
    // Print Title
	print_heading(get_string('showim', 'genetic'), 'center',2);	
	...
	echo "<NOBR><TD>&nbsp;&nbsp;<a href=\"viewim.php?id=$id&order=ALPHABETIC&language=en\" target='_self'><img src=\"images/en.png\"'></a></TD>&nbsp;&nbsp;</NOBR>";	 
	...
	$table->head  = array ($strname,$strdescription,$strsrc,$straction);
	...
	while ($row = mysql_fetch_array($result)) {
		...
		//si no hay descripci�n se muestra el mensaje pertinente
		if($name2==''){
